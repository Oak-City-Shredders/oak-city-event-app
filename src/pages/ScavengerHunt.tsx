  ...
  return (
    <IonPage>
      ...
      <IonContent>
        ...
        >
          <img src="/images/scavenger-hunt-small.webp" alt="Scavenger Hunt" />
        </div>
                ...
                <div className="ion-margin-bottom">
                  <IonText>
                    ...
                    <p>
                      ...
                      you'll need your wits, eyes, and maybe a little luck to
                      find them all.
                    </p>
                  </IonText>
                </div>
                ...
                <div className="ion-margin-bottom">
                  ...
                  <IonItem lines="full">
                    ...
                    <IonLabel>
                      ...
                      <p>
                        The person who collects the most purple squirrels will
                        snag an exclusive prize.
                      </p>
                    </IonLabel>
                  </IonItem>
                  ...
                  <IonList>
                    ...
                    <IonItem lines="full">
                      ...
                      <IonLabel>
                        ...
                        <p>Score the big stuff with prizes valued at $150+!</p>
                      </IonLabel>
                    </IonItem>
                  </IonList>
                </div>
