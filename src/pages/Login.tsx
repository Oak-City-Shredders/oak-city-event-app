...
const Login: React.FC = () => {
    ...
    const handleForgotPassword = async () => {
        ...
        try {
            ...
            setError("Check your email and Spam folder for message with a link to reset your password.")
            ...
            <IonContent className="ion-padding">
                {user ? (
                    ...
                    <>
                        ...
                        <IonItem>
                            <IonInput type="password" value={password} placeholder="Password" onIonInput={(e: any) => setPassword(e.target.value)} />
                        </IonItem>
                        ...
                        <IonButton expand="full" onClick={handleCreate}>Create User</IonButton>
                        <IonButton expand="full" onClick={handleForgotPassword}>Forgot Password</IonButton>
                    </>
                )}
            </IonContent>
        </IonPage>
